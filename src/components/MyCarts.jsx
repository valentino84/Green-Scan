          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="text-right text-sm text-green-600 dark:text-green-400">
                <div>Created: {cart.createdDate}</div>
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-green-700 dark:text-green-300">{cart.createdDate}</span>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-green-700 dark:text-green-300">{cart.totalItems} items • {cart.totalWeight}kg</span>
            </div>

            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600 dark:text-gray-400">GreenCoins:</span>
              <span className="text-green-700 dark:text-green-300">
                {cart.actualCoins ? `${cart.actualCoins} (actual)` : `${cart.estimatedCoins} (estimated)`}
              </span>
            </div>
